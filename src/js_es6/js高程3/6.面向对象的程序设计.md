...
```
![函数的原型属性image](images/6_1_原型模式.png)
...
![6_0_实例属性与原型属性.png](images/6_0_实例属性与原型属性.png)
...
```
![重写原型对象image](images/6_2_重写原型属性.png)
...
![6_3_原型对象为另一个对象的实例.png](images/6_3_原型对象为另一个对象的实例.png)
...
![原型链继承image](./images/6_4_原型链继承.png)
#### 原型链的问题
...
```
![6_5_原型式继承.png](images/6_5_原型式继承.png)
...
![6_6_寄生式继承.png](images/6_6_寄生式继承.png)
