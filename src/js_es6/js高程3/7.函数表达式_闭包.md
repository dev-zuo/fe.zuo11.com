...
![7_1_普通函数执行作用域链.png](images/7_1_普通函数执行作用域链.png)
...
![7_2_闭包函数执行的作用域链.png](images/7_2_闭包函数执行的作用域链.png)
...
tempfunc[9]() // 10
```
![7_4_闭包作用域副作用.png](images/7_4_闭包作用域副作用.png)
...
tempfunc[9]() // 9
```
![7_5_闭包副作用解决方法.png](images/7_5_闭包副作用解决方法.png)
