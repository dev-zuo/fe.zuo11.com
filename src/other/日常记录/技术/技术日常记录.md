...
### 2020/03/28 周六
#### 网页dark mode(深色模式)适配
微信最近微信推出了暗黑模式，我试了下，手机切换时页面效果样式是实时刷新的。于是就想着web怎么能够监听暗黑模式，并设置样式。查了资料后，在Stack Overflow上找到了答案
...
```
深色模式下，一般讲背景调暗，字体设置为偏白色即可。zuo11.com 已用上面的方法适配了深色模式，可以体验下。网站是开源的，[zuo11.com深色模式支持代码 - github](https://github.com/zuoxiaobai/zuo11.com/blob/master/src/global.css)
