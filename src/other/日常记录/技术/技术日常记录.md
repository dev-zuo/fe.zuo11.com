...
![vuepress_tasklist.png](images/vuepress_tasklist.png)
...
![vuepress_1.png](images/vuepress_1.png)
...
![vuepress_2.png](images/vuepress_2.png)
...
![vuepress_3.png](images/vuepress_3.png)
...
![sort_ch.png](images/sort_ch.png)
...
![is_same_week.png](images/is_same_week.png)
...
![console_color.png](images/console_color.png)
...
![console_img.gif](images/console_img.gif)
...
![config-yargs_error.png](images/config-yargs_error.png)
...
![z_chart_doc.png](images/z_chart_doc.png)
...
![github_custom_domain.png](images/github_custom_domain.png)
...
![github_custom_domain_2.png](images/github_custom_domain_2.png)
...
![github_custom_domain_3.png](images/github_custom_domain_3.png)
...
![github_pages.png](images/github_pages.png)
...
![lodash_need_1.png](images/lodash_need_1.png)
...
![lodash_need_2.png](images/lodash_need_2.png)
...
![lodash_need_3.png](images/lodash_need_3.png)

在来看看 report 信息，可以看到，只打包了使用到的函数

![lodash_need_4.png](images/lodash_need_4.png)
...
![multi_umd_1.png](images/multi_umd_1.png)
...
![multi_umd_2.png](images/multi_umd_2.png)
...
![chrome_load_events.png](images/chrome_load_event.png)
...
![script_load.png](images/script_load.png)
...
![vue_vendor_ optimize_1.png](images/vue_vendor_ optimize_1.png)

主要是 chunk-vendors.js 接近 1.7M，下载时间较长。npm run build 打包后 log 如下图(这是后面补的图，中间把路由懒加载改了下，size 会比上图里的小一点)，超出建议的 244kB

![vue_vendor_ optimize_2.png](images/vue_vendor_ optimize_2.png)
...
![vue_vendor_ optimize_3.png](images/vue_vendor_ optimize_3.png)
...
![vue_vendor_ optimize_4.png](images/vue_vendor_ optimize_4.png)
...
![vue_vendor_ optimize_5.png](images/vue_vendor_ optimize_5.png)

对应的 report.html 图如下，可以看到 

![vue_vendor_ optimize_6.png](images/vue_vendor_ optimize_6.png)
...
![vue_vendor_ optimize_7.png](images/vue_vendor_ optimize_7.png)
...
![vue_vendor_ optimize_8.png](images/vue_vendor_ optimize_8.png)

对应的 report.html 图如下，其实吧 vue-router、vuex 也使用 cdn 可能 vendor 会更小，但感觉不是很必要了。vendors.js 已经很小了

![vue_vendor_ optimize_9.png](images/vue_vendor_ optimize_9.png)
...
![vue_vendor_ optimize_10.png](images/vue_vendor_ optimize_10.png)
...
![vue_vendor_ optimize_11.png](images/vue_vendor_ optimize_11.png)

上面的图，是取的均值。再次刷新可能会低于 1s，也可能会高于。我这里在测试时都勾选了 Disable cache。就是不使用缓存，有时候可能 dns 解析，https 验证时间、服务器响应时间会有差别。

![vue_vendor_ optimize_12.png](images/vue_vendor_ optimize_12.png)
...
![vue_prototype_undefined.png](images/vue_prototype_undefined.png)
...
![vue_config_js_plugins.png](images/vue_config_js_plugins.png)
...
![vue_at_mention.gif](images/vue_at_mention.gif)
...
![https_cert_1.png](images/https_cert_1.png)
...
![https_cert_2.png](images/https_cert_2.png)
...
![cross_origin_script_error.png](images/cross_origin_script_error.png)
...
![cross_origin_script_error_fix.png](images/cross_origin_script_error_fix.png)
...
![waterfall-hover.png](images/waterfall-hover.png)
...
![append_vs_appendChild.png](images/append_vs_appendChild.png)
...
![google站长工具对比](images/google_ad_3.png)
...
![网站已下线或无法访问怎么解决](images/google_ad_1.png)
...
![域名解析.png](images/google_ad_2.png)
...
![google_ad.jpg](images/google_ad.jpg)
...
![final_cut_export_wav.png](images/final_cut_export_wav.png)
...
![final_cut_wav2caption.png](images/final_cut_wav2caption.png)

生成好后，点击进入详情页，可对生成的字幕进行修改，修改完成后点击导出，会生成 .srt 字幕文件

![final_cut_edit_caption.png](images/final_cut_edit_caption.png)
...
![final_cut_import_fail.png](images/final_cut_import_fail.png)
...
![final_cut_add_zimu.png](images/final_cut_add_zimu.png)
...
![final_cut_not_fullscreen.png](images/final_cut_not_fullscreen.png)
...
![final_cut_too_large.png](images/final_cut_too_large.png)
...
![final_cut_audio.png](images/final_cut_audio.png)
...
![git_push_hang_up.png](images/git_push_hang_up.png)
...
![githu_ssh_key.png](images/githu_ssh_key.png)
...
![qrcode_js.png](images/qrcode_js.png)
...
![Gifox_edit.png](images/Gifox_edit.png)
...
![npm_zuo_1.png](./images/npm_zuo_1.png)
...
![npm_zuo_2.png](./images/npm_zuo_2.png)
...
![npm_zuo_3.png](./images/npm_zuo_3.png)
...
```
![subcomp_samename.png](images/subcomp_samename.png)
...
![sub_comp_hooks.png](images/sub_comp_hooks.png)
...
![git_chinese_show.png](images/git_chinese_show.png)
...
![ruby_brew_1.png](images/ruby_brew_1.png)
...
![ruby_brew_2.png](images/ruby_brew_2.png)
...
![nginx_down.png](images/nginx_down.png)
...
![z-echart.gif](images/z-echart.gif)
...
![before_normalize.png](images/before_normalize.png)

使用 normalize.css 后的效果 

![after_normalize.png](images/after_normalize.png)
...
![npm_run_multi.png](images/npm_run_multi.png)
...
![default_browser.png](images/default_browser.png)
...
![eslint-fix-1.png](images/eslint-fix-1.png)
...
![eslint-fix-2.png](images/eslint-fix-2.png)

保存后会自动fix，由于两个变量没使用还是会报警告，我用console.log打印了下，就没warning了

![eslint-fix-3.png](images/eslint-fix-3.png)
...
![vue_create_perset.png](images/vue_create_perset.png)
...
![vue_chart_build_lib.png](images/vue_chart_build_lib.png)
...
![vue_chat_test1.png](images/vue_chat_test1.png)
...
![vue_chat_test2.png](images/vue_chat_test2.png)
...
![unpkg_info.png](images/unpkg_info.png)
...
![vue_chart_npm_push.png](images/vue_chart_npm_push.png)
...
![guoqzuo_vue_chart.png](images/guoqzuo_vue_chart.png)
...
![dosify_vuep_ve_charts.png](images/dosify_vuep_ve_charts.png)
...
![elementui_doc_source.png](images/elementui_doc_source.png)
...
![send_mail_png.png](images/send_mail_png.png)
...
![node_echarts_img.png](images/node_echarts_img.png)
...
![vscode_plugin_1.png](images/vscode_plugin_1.png)

网上说要装一个 run code的 vscode插件，也装了。后面发现还是不行，点击正在生成，ctrl + c 就弹出一个名为 "扩展开发宿主" 的新窗口了，里面可以调试插件，如下图

![vscode_plugin_2.png](images/vscode_plugin_2.png)
...
![vscode_plugin_3.png](images/vscode_plugin_3.png)

出现如下弹窗消息，就说明跑的没问题了

![vscode_plugin_4.png](images/vscode_plugin_4.png)
...
![el_debounce.png](images/el_debounce.png)
...
![edit_commit_rebase_1.png](images/edit_commit_rebase_1.png)

按ESC, 再按a进入INSERT模式, 将上上次提交的信息前的pick改为edit，如下图，按ESC, shift + : 进入命令模式，输入x 或wq保存，不熟悉vim操作的可以搜索下vim教程

![edit_commit_rebase_2.png](images/edit_commit_rebase_2.png)
...
![edit_commit_rebase_3.png](images/edit_commit_rebase_3.png)
...
![Object_assign.png](images/Object_assign.png)
...
![what_cookie_1.png](images/what_cookie_1.png)
...
![what_cookie_2.png](images/what_cookie_2.png)
...
![what_cookie_3.png](images/what_cookie_3.png)
...
![what_cookie_4.png](images/what_cookie_4.png)
...
![what_cookie_5.png](images/what_cookie_5.png)
...
![special_table.png](images/special_table.png)
...
![github_clone_slow.png](images/github_clone_slow.png)
...
![a_com_tongji.png](images/a_com_tongji.png)
...
![table_slash.png](images/table_slash.png)
...
![expires_header.png](images/expires_header.png)
...
![cachecontrol_max-age.png](images/cachecontrol_max-age.png)
...
![week_cache.png](images/week_cache.png)
...
![echarts_round.png](./images/echarts_round.png)
...
![input_highlight_key.gif](./images/input_highlight_key.gif)
...
![v_loading.gif](./images/v_loading.gif)
...
![ie_jserror.png](./images/ie_jserror.png)
...
![text_align_justify.png](images/text_align_justify.png)
...
![json_stringify.png](images/json_stringify.png)
...
![css_filter.png](images/css_filter.png)
...
![canvas_progress.png](images/canvas_progress.png)
...
![cavas_unnormal_shape.png](images/cavas_unnormal_shape.png)
...
![badge徽章图片.png](images/badge徽章图片.png)
...
![修改本地时间后获取时间.png](images/修改本地时间后获取时间.png)
...
![border边框.png](images/border边框.png)
